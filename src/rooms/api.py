...
from src.rooms.schemas import JoinRequest, RoomCreateRequest, RoomResponse
from src.rooms.services import create_room, join_room, leave_room
...
async def create_room_endpoint(
    ...
    try:
        room = await create_room(current_user.user_id, request.max_guest, db)
        return room
...
async def join_room_endpoint(
    ...
    token = auth_token.split(" ")[1] if auth_token else None
